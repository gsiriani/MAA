...
class Id3:
    ...
    def ejecutar(self, ejemplos, atributos, maxDepth = None):
        ...
        # Agrego la rama ELSE para cubrir los valores que puedan no aparecer en los casos de prueba
    ...
    def valoresPosibles(self, atributo, ejemplos):
        '''
        Retorna todos los diferentes valores que toma un atributo en los casos
        de entrenamiento
        '''
